        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="space-y-3 md:space-y-6">
            <div className="space-y-2 md:space-y-4">
              <p className="text-purple-400 dark:text-purple-300 font-futuristic font-medium text-xs md:text-base tracking-wider uppercase animate-fade-in scroll-animate">
                {"> Initializing Developer Mode..."}
              </p>
              
              {/* Enhanced Developer Name with Better Mobile Layout */}
              <h1 className="font-robotic text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-2 md:mb-4 animate-fade-in-delay scroll-animate">
                <div className="flex flex-col items-center space-y-1 sm:space-y-2 md:space-y-0 md:flex-row md:justify-center md:items-center md:space-x-4">
                  ...
                  <span className="relative inline-block">
                    ...
                    {/* Sparkle effects */}
                    <Sparkles className="absolute -top-2 -right-2 w-4 h-4 md:w-6 md:h-6 text-cyan-400 animate-pulse" />
                  ...
                  <span className="relative inline-block">
                    ...
                    <span className="absolute -left-3 top-0 text-emerald-400 animate-pulse text-sm md:text-lg">{"<"}</span>
                    <span className="absolute -right-3 top-0 text-blue-400 animate-pulse delay-300 text-sm md:text-lg">{">"}</span>
                  </span>
                </div>
              </h1>
              
              {/* Subtitle with Mobile-Optimized Text */}
              <div className="font-futuristic text-xs sm:text-sm md:text-lg lg:text-xl text-slate-300 dark:text-slate-200 mb-2 scroll-animate px-2">
            ...
            <div className="h-8 md:h-16 flex items-center justify-center animate-fade-in-delay-2 scroll-animate px-2">
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-slate-400 dark:text-slate-300 font-futuristic text-center">
                <span className="text-green-400 dark:text-green-300 font-mono">[STATUS]</span> Ready to execute innovative solutions...
              </p>
            </div>
            
            <p className="text-xs sm:text-sm md:text-base text-slate-400 dark:text-slate-300 mb-4 md:mb-6 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay-3 font-futuristic scroll-animate px-4">
            ...
            <div className="flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-center sm:gap-3 sm:space-y-0 mb-6 md:mb-8 animate-fade-in-delay-4 scroll-animate px-4">
              <a
                href="https://drive.google.com/file/d/1example-resume-link/view"
                target="_blank"
                rel="noopener noreferrer"
                className="group bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 font-futuristic text-xs sm:text-sm md:text-base"
              >
              ...
              <button 
                ...
                className="group border border-slate-600 dark:border-slate-500 text-slate-300 dark:text-slate-200 hover:border-purple-500 hover:text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 font-futuristic text-xs sm:text-sm md:text-base"
              >
                <Play className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
                <span>RUN_PORTFOLIO.BAT</span>
              </button>
            </div>

            {/* Social Links - Mobile Optimized */}
            <div className="flex items-center justify-center space-x-2 sm:space-x-4 animate-fade-in-delay-5 scroll-animate mb-6 md:mb-0">
              <a
                href="https://github.com/johndeveloper"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-slate-800/50 dark:bg-slate-700/50 backdrop-blur-sm border border-slate-700 dark:border-slate-600 hover:bg-gradient-to-r hover:from-purple-500 hover:to-cyan-500 hover:border-transparent rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg group"
              >
                <Github className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform text-white" />
              </a>
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-slate-800/50 dark:bg-slate-700/50 backdrop-blur-sm border border-slate-700 dark:border-slate-600 hover:bg-gradient-to-r hover:from-purple-500 hover:to-cyan-500 hover:border-transparent rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg group"
              >
                <Linkedin className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform text-white" />
              </a>
              <a
                href="mailto:hello@johndeveloper.com"
                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-slate-800/50 dark:bg-slate-700/50 backdrop-blur-sm border border-slate-700 dark:border-slate-600 hover:bg-gradient-to-r hover:from-purple-500 hover:to-cyan-500 hover:border-transparent rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg group"
              >
                <Mail className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform text-white" />
              </a>
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-slate-800/50 dark:bg-slate-700/50 backdrop-blur-sm border border-slate-700 dark:border-slate-600 hover:bg-gradient-to-r hover:from-purple-500 hover:to-cyan-500 hover:border-transparent rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg group"
              >
                <Code2 className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform text-white" />
              </a>
            </div>

            {/* Stats - Mobile Optimized Grid */}
            <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-4 md:gap-6 mt-6 md:mt-8 animate-fade-in-delay-6 scroll-animate px-2">
              {[
                ...
                <div key={index} className="text-center group">
                  <div className="bg-slate-800/30 dark:bg-slate-700/30 backdrop-blur-sm border border-slate-700/50 dark:border-slate-600/50 rounded-lg p-2 sm:p-3 md:p-4 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
                    <div className="text-xs text-green-400 dark:text-green-300 font-mono mb-1 opacity-70">
                      {stat.code}
                    </div>
                    <div className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent mb-1 font-robotic">
                      {stat.number}
                    </div>
